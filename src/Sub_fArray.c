 ...
 * Subtracts array 2 from array 1 and saves the result in 'Sub_fArray_out.txt'.
 */
...
void main(int argc, char *argv[]) {
	...
	if(argc != 3) {
		...
		printf("\n Sub_fArray.exe 'filename_array1' 'filename_array2'");
		printf("\n\n");
		exit(EXIT_FAILURE);
	}
	char *file1 = argv[1];
	...
	StoreFloatInFile("Sub_fArray_out.txt", nDataResult, dataResult);
