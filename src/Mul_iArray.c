 ...
 * Multiplies array 1 to array 2 and saves the result in 'Mul_iArray_out.txt'.
 */
...
void main(int argc, char *argv[]) {
	...
	if(argc != 3) {
		...
		printf("\n Mul_iArray.exe 'filename_array1' 'filename_array2'");
		printf("\n\n");
		exit(EXIT_FAILURE);
	}
	char *file1 = argv[1];
	...
	StoreIntInFile("Mul_iArray_out.txt", nDataResult, dataResult);
