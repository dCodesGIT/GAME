 ...
 * Subtracts a number from an array and saves the result in 'Sub_iNumber_out.txt'.
 */
...
void main(int argc, char *argv[]) {
	...
	if(argc != 3) {
		...
		printf("\n Sub_iArray.exe 'filename_array1' 'integer'");
		printf("\n\n");
		exit(EXIT_FAILURE);
	}
	char *file1 = argv[1];
	...
	StoreIntInFile("Sub_iNumber_out.txt", nDataResult, dataResult);
